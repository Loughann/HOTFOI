...
import { Globe, Heart, MessageCircle, Instagram, Camera, Video, ImageIcon, PlayCircle, Lock } from 'lucide-react'
...
export default function ProfilePage() {
  ...
  const displayedText = needsTruncation && !showFullBio
    ? fullBio.substring(0, bioMaxLength) + '...'
    : fullBio;
          ...
          <div className="space-y-3 mb-6">
            ...
            >
              <div className="text-center">
                ...
                <div className="text-sm opacity-90">
                  <span className="line-through">De R$ 47,00</span> por <span className="text-base font-bold">R$ 10,00</span>
                </div>
              </div>
            </Button>
            ...
            >
              <div className="text-center">
                ...
                <div className="text-sm opacity-90">
                  <span className="line-through">De R$ 197,00</span> por <span className="text-base font-bold">R$ 37,00</span>
                </div>
              </div>
            </Button>
          </div>
